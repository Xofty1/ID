    ...
    <div className="min-h-screen bg-[#0B0B0C] flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-12 py-8 md:py-0 relative">
        ...
        <div className="space-y-3 mb-8 md:mb-10 max-w-md">
          {[
            { text: 'Хочу пожелать тебе достижения больших вершин во всех сферах жизни. Пусть твое дело всегда будет для тебя не просто рутиной, а настоящим источником огня. Желаю, чтобы этот свет горел так ярко, что ты могла освещать им всё вокруг себя, даря тепло и вдохновение всем.', delay: 0.5 },
            { text: 'И самое главное — пусть в твоей жизни будут только искренние люди. Те, кто не просто разделят с тобой радость, но и в трудную минуту молча подставят плечо, помогут и поддержат. Чтобы любые эмоции — и смех, и слезы — делились, делая каждое переживание легче, а каждую победу — значимее. Свети, живи и будь счастлива!', delay: 0.62 },
          ].map(({ text, delay }, i) => (
